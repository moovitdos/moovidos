  ...
  const SITE_INFO_CONTENT = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'רוצים להגיע ליעד? הזינו מאיפה לאן, ומובידוס תציג את מסלולי הנסיעה הטובים ביותר. האפליקציה כוללת חיפוש מתקדם המאפשר הגדרת כמות החלפות, הליכות ובחירת שעת יציאה או הגעה.'
      },
      {
      ...
      },
      {
        ...
        content: 'האפליקציה מאפשרת מעקב רציף אחר התקדמות הנסיעה והקראה קולית של התחנות לאורך המסלול, ובנוסף מציעה אפשרות להגדרת תזכורת והתראה (בצליל או ברטט) לקראת ההגעה לתחנת היעד.'
      },
      {
        title: 'תכונות נוספות',
      ...
      },
      {
        ...
        content: 'האפליקציה פותחה ועוצבה במיוחד עבור מכשירים בעלי מקשים פיזיים, ומאפשרת ניווט מלא ומהיר באמצעות מקשים ללא צורך במסך מגע. המערכת מזהה אוטומטית את סוג המכשיר ומספקת חוויית שימוש חלקה ומהירה, הכוללת הדגשה ברורה של פריטים נבחרים וקיצורי דרך יעילים.'
      },
      {
        title: 'עלות ורכישה',
        ...
        price: 'רכישה חד-פעמית של 15 ש"ח — בלי מנוי, בלי תשלום חוזר, לתמיד.',
